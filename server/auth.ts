...
<div class="card">
  ...
  <div id="btn" class="g_id_signin" data-type="standard" data-theme="outline" data-size="large" data-shape="pill" data-text="signin_with" data-logo_alignment="center" data-width="280"></div>
  <div id="err"></div>
</div>
<script>
  const RD = ${target};
