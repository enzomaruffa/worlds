...
- `sdk/src/` — the SDK, one module per concern (`db ai channels uploads notify room rooms util
...
- **red-light / paint-arena / racing** — single `worlds.room` ready-up + `worlds.ws` realtime
